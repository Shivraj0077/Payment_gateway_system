        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-background/80 backdrop-blur-md border-b border-gray-100 dark:border-slate-800 transition-colors">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <Link href="/merchant/login" className="hidden sm:block text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors px-4 py-2">
                        Sign In
                    </Link>

                    <Link href="/merchant/onboarding" className="hidden sm:block text-sm bg-gray-900 dark:bg-white text-white dark:text-slate-900 px-4 py-2 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors font-medium">
                        Get Started
                    </Link>
                ...
                <div className="md:hidden bg-white dark:bg-background border-t border-gray-100 dark:border-slate-800 transition-colors">
                    <div className="px-4 py-4 space-y-3">
                        ...
                        <div className="pt-4 border-t border-gray-100 dark:border-slate-800 flex flex-col gap-3">
                            <Link href="/merchant/login" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors py-2 text-left">
                                Sign In
                            </Link>
                            <Link href="/merchant/onboarding" className="text-sm bg-gray-900 dark:bg-white text-white dark:text-slate-900 px-4 py-2 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors font-medium w-full text-center">
                                Get Started
                            </Link>
                        </div>
                    </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    <div className="max-w-2xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                            <Link href="/merchant/onboarding" className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-6 py-3 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 text-sm font-medium w-full sm:w-auto">
                                Start Integration <ArrowRight className="w-4 h-4" />
                            </Link>
                            <Link href="/developers" className="border border-gray-300 dark:border-slate-700 text-gray-700 dark:text-white px-6 py-3 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors flex items-center justify-center gap-2 text-sm font-medium w-full sm:w-auto">
        ...
        <section className="py-20 sm:py-32 px-4 sm:px-6 bg-white dark:bg-background transition-colors">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-12 sm:mb-16">
                    <Link href="/merchant/onboarding" className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 font-medium w-full sm:w-auto">
                        Get API Keys <ArrowRight className="w-4 sm:w-5 h-4 sm:h-5" />
                    </Link>
                    <Link href="/developers" className="border border-gray-300 dark:border-slate-700 text-gray-700 dark:text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors flex items-center justify-center gap-2 font-medium w-full sm:w-auto">
